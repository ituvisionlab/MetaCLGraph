...
if __name__ == '__main__':
    ...
    parser.add_argument("--dataset", type=str, default='Reddit-CL', help='Products-CL, Reddit-CL, Arxiv-CL, CiteSeer-CL')
    ...
    parser.add_argument('--method', type=str,
                        choices=["bare", 'lwf', 'gem', 'ewc', 'mas', 'twp', 'jointtrain', 'ergnn', 'joint','metaclgraph'], default="metaclgraph",
    ...
    parser.add_argument('--ergnn_args', type=str2dict, default={'budget': [10], 'd': [0.5], 'sampler': ['CM']},
                        help='sampler options: CM, CM_plus, MF, MF_plus')
    parser.add_argument('--metaclgraph_args', type=str2dict, default={'budget': [10], 'd': [0.5], 'sampler': ['random']},
    ...
    parser.add_argument('--twp_args', type=str2dict, default={'lambda_l': [10000], 'lambda_t': [10000], 'beta': [0.1]})
    parser.add_argument('--ewc_args', type=str2dict, default={'memory_strength': [1000000.]})
    parser.add_argument('--mas_args', type=str2dict, default={'memory_strength': [1]})
    ...
    parser.add_argument('--jointmaml_args', type=str2dict, default={'Na': None})
    ...
    method_args = {'ergnn': args.ergnn_args, 'lwf': args.lwf_args, 'twp': args.twp_args, 'ewc': args.ewc_args,
                   'bare': args.bare_args, 'gem': args.gem_args, 'mas': args.mas_args, 'joint': args.joint_args, 'metaclgraph': args.metaclgraph_args}
